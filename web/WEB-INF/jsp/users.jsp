...
<div class="container">
    <table class="table table-striped">
        ...
        <c:forEach var="user" items="${requestScope.users}">
            <tr>
                <td><a href="/Controller?command=viewUser&clientId=${user.id}"><span class="glyphicon glyphicon-edit"></span></a></td>
                <td>${user.login}</td>
                <td><span class="glyphicon <c:if test="${user.banned == true}">glyphicon-ok</c:if> <c:if test="${user.banned == false}">glyphicon-remove</c:if>"></span></td>
