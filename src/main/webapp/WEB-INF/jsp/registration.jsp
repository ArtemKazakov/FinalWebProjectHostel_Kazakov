...
<div class="container">
    <div class="jumbotron">
        <div class="row">
            ...
            <div class="col-md-6">
                <form onsubmit="return checkPassword('${repeatPasswordError}')" action="${pageContext.request.contextPath}/Controller" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input name="registrationFormIdentificationNumber" type="number"
                               ...
                               class="form-control" id="identification-number" title="${invalidPassportNumber}" required
                    ...
                    <div class="form-group">
                        ...
                        <input name="registrationFormPatronymic" type="text" value="${param.registrationFormPatronymic}"
