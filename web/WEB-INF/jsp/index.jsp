...
<f:message bundle="${locale}" key="locale.singleRoom" var="singleRoom"/>
<f:message bundle="${locale}" key="locale.doubleRoom" var="doubleRoom"/>
<f:message bundle="${locale}" key="locale.tripleRoom" var="tripleRoom"/>
<f:message bundle="${locale}" key="locale.quadrupleRoom" var="quadrupleRoom"/>
...
<f:message bundle="${locale}" key="locale.plus4header" var="plus1header"/>
...
<div class="jumbotron">
  <div class="container">
    ...
    <div class="ta_center">
    <h2>${mainPageTextHeader}</h2>
    <div class="st1">${mainPageText1} <a href="Controller?command=registration">${mainPageText2}</a> <br> ${mainPageText3}</div>
    <div class="row">
      <div class="col-md-6">
        <a href="#" class="banner">
