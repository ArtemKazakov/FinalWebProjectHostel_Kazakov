...
public class MySQLDiscountDAO implements DiscountDAO {
    ...
    public void updateValue(Discount discount) throws DAOException {
        ...
        try {
            connection = connectionPool.getConnection();
            preparedStatement = connection.prepareStatement(UPDATE_DISCOUNT_VALUE_QUERY);
            ...
            throw new DAOException("DAO layer: cannot update discount value", e);
        } finally {
            closeStatement(preparedStatement);
            if (connection != null) {
                try {
    ...
    public Discount findById(int id) throws DAOException {
        ...
        try {
            connection = connectionPool.getConnection();
            preparedStatement = connection.prepareStatement(SELECT_DISCOUNT_BY_ID_QUERY);
            ...
            throw new DAOException("DAO layer: cannot select discounts by id", e);
        } finally {
    ...
    @Override
    public List<Discount> findUnusedByClientIdAnd(int id) throws DAOException {
        ConnectionPool connectionPool = ConnectionPool.getInstance();
        Connection connection = null;
        PreparedStatement preparedStatement = null;
        ResultSet resultSet = null;
        ...
        try {
            connection = connectionPool.getConnection();
            preparedStatement = connection.prepareStatement(SELECT_UNUSED_DISCOUNTS_BY_CLIENT_ID_QUERY);
            ...
            throw new DAOException("DAO layer: cannot select unused discounts by client id", e);
        } finally {
            closeResultSet(resultSet);
            closeStatement(preparedStatement);
            if (connection != null) {
